...
export default function WhatWeTasksSolveCard({
  ...
  return (
    <div className="flex h-[142px] w-full items-center gap-[clamp(16px,2vw,24px)] rounded-[24px] bg-white/10 pr-[clamp(24px,2vw,76px)] pl-[clamp(16px,2vw,32px)] xl:justify-between xl:gap-0">
      <div
        className={cn(
