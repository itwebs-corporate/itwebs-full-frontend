...
export const TECH_STACK: TechItem[] = [
  ...
  { title: 'HTML', icon: 'logos:html-5' },
  { title: 'CSS', icon: 'logos:css-3' },
  ...
  { title: 'FastAPI', icon: 'logos:fastapi-icon' },
  { title: 'Django', icon: 'logos:django' },
  ...
  { title: 'Claude', icon: 'logos:anthropic-icon' },
];
