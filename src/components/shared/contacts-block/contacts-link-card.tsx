...
export default function ContactsLinkCard({ item }: { item: LinkCard }) {
  return (
    <li
      className="flex min-h-[75px] w-[clamp(158px,32vw,344px)] flex-col gap-[clamp(14px,2.5vw,20px)] rounded-[clamp(12px,2.2vw,24px)] bg-white py-[clamp(14px,2.2vw,24px)] pl-[clamp(12px,2vw,20px)] sm:h-[122px]"
      key={item.id}
    >
