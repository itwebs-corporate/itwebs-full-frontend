...
export async function generateMetadata(): Promise<Metadata> {
  return buildPageMetadata({
    path: PAGES_CONFIG.MOHILEV,
    by: {
      title: 'IT-компания в Могилеве: разработка сайтов, приложений, ПО, SEO и поддержка | ITWEBS',
      description:
        'Могилев, заряжай! Мы — IT-компания с опытом работы в Европе и США. Разрабатываем сайты, приложения, ПО, SEO и поддержку. Хотите проект, который выделит вас? Заходите обсудить. ITWEBS.',
    },
    'key-words': [
      'разработка сайтов Могилев',
      'разработка приложений Могилев',
      'IT компания Могилев',
      'создание ПО Могилев',
      'SEO продвижение Могилев',
      'IT поддержка Могилев',
      'заказать разработку Могилев',
    ],
  });
}

export default function MohilevPage() {
  return (
    <>
      <HeroBlock
        description="Могилев, заряжай! ⚡️ Мы — IT-компания с опытом в Европе и США. Разрабатываем сайты, мобильные приложения, ПО, делаем SEO и поддержку. Хотите проект, который выделит вас? Заходите обсудить"
        fullScreen
        heading="Компания разработчик ПО в Могилеве"
      >
      ...
      <SeoTextBlock
        description={
          <>
            <p className="mb-4">
              ...
              миру. Нам доверяют бизнесы из Могилева, Москвы, Варшавы и Нью-Йорка. Почему? Потому
              что мы умеем делать качественные продукты, которые решают реальные задачи и приносят
              прибыль.
            </p>
            <p className="mb-4 font-bold">Что мы предлагаем бизнесу в Могилеве:</p>
            <ul className="mb-4 list-disc space-y-2 pl-6">
              ...
              <li>
                ...
                Могилеву, Беларуси и миру. Работаем с мультиязычными проектами, учитываем
            ...
            <p className="mb-4 font-bold">Почему выбирают нас в Могилеве?</p>
            <p>
        ...
        title={
          <>
            <b className="text-primary">IT-компания в Могилеве:</b> разработка сайтов, приложений,
            ПО, SEO и поддержка
          </>
        }
      />
